...
plot(seq(1,iteration_times+1),colMedians(ite_median_est),xlab=expression(paste('iteration times', ~k)),ylab=TeX("$\\hat{\\theta}_k$"),main='Accelerated iE taking median by 10000 experiments. Exp(5). n=20')
